...
//        newEvent.Details = "&quot;There are too many idea and things and people, too many directions to go. I was starting to believe the reason it matters care passionately about something is that it whittles the world down to more manageable size.&quot-Charlie Kaufman (From Adaption)<br>" +
...
//        newEvent.Rules ="<ul>" +
//                "<li> The event is strictly online, hence last day of submission of your script is the second day of the Fest.</li>" +
...
//                        "</ul>",
//                1,2,100,0,"N/A","4 Hours",clubUniqueIds[0],"N/A","N/A",true);
//                eventData=mDatabase.push();
//                eventData.setValue(newEvent);
...
//                        "<li> Change of rules and/or time and acceptability of entries are at the discretion of the Organizing Committee members.</li>" +
//                        "</ul>",
//                2,5,100,0,"N/A","N/A",clubUniqueIds[0],"N/A","N/A",true);
//        eventData=mDatabase.push();
//        eventData.setValue(newEvent);
...
//                "<li> Change of rules and/or time and acceptability of entries are at the discretion of the Organizing Committee members.</li>" +
//                "</ul>",
//                1,1,100,0,"N/A","N/A",clubUniqueIds[0],"N/A","N/A",true);
//                eventData=mDatabase.push();
//                eventData.setValue(newEvent);
...
//                        "</ul> "
//                ,1,1,0,0,"N/A","N/A",clubUniqueIds[0],"N/A","N/A",true);
//        eventData=mDatabase.push();
//        eventData.setValue(newEvent);
//                newContact = new Contact();
...
//                "</ul>","N/A",clubUniqueIds[5],"N/A","N/A",true);
//                eventData=mDatabase.push();
//                eventData.setValue(newEvent);
...
//                        "</ul>",
//                "N/A",clubUniqueIds[5],"N/A","N/A",true);
//                eventData=mDatabase.push();
//                eventData.setValue(newEvent);
...
//                        "</ul>",   "N/A", clubUniqueIds[6],"N/A","N/A",true );
//                        eventData=mDatabase.push();
//                        eventData.setValue(newEvent);
...
//                        "<li> Participants must carry their own pens.</li>" +
//                        "</ul>",
//                "N/A",clubUniqueIds[6],"N/A","N/A",true);
//                eventData=mDatabase.push();
//                eventData.setValue(newEvent);
